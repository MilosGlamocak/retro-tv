...
const CRT_FRAGMENT = `
  ...
  void main() {
    ...
    // Vignette za rubove ekrana (crno van krivine)
...
export function CRTScreen({ geometry, videoSrc }: CRTScreenProps) {
